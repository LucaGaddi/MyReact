...
function TodoCard(props) {
  const { titolo, dataDiScadenza, utente, priorita, checked, onChange, deleteOnClick, editOnClick } = props;
    ...
    <Card>
      <div className="w-full flex justify-between items-center">
        <div className="flex items-center">
          ...
          <span className="relative text-base text-gray-500 ml-5">
              <span className="absolute text-xs left-0 -top-5">Utente:</span>
              {utente}
            </span>
        </div>
